...
<div
  class="flex flex-col h-full bg-slate-50/50 border-r border-slate-100 overflow-hidden"
>
        ...
        {#each notes as note (note.id)}
          <div class="px-2 py-1">
            <button
              ...
              class="group w-full text-left p-4 transition-all relative rounded-md
            ...
            >
              <div class="flex flex-col gap-1">
                <span
                  class="text-sm font-bold truncate {activeNoteId === note.id
                    ? 'text-slate-900'
                    : 'text-slate-700'}"
                >
                  {note.title ||
                ...
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-xs text-slate-400 truncate opacity-70">

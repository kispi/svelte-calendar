...
const translations = {
  en: {
    ...
    chatbot: {
      ...
      title: 'Scheduly',
      listening: 'Listening...',
      mic_access_denied_title: 'Microphone Access Denied',
  ...
  ko: {
    ...
    chatbot: {
      ...
      title: 'Scheduly',
      listening: '듣고 있습니다...',
      mic_access_denied_title: '마이크 권한 거부됨',
      mic_permission_denied: '마이크 권한이 거부되었습니다. 브라우저 설정을 확인해주세요.',
      browser_not_supported_title: '브라우저 미지원',
      browser_not_supported: '이 브라우저는 음성 인식을 지원하지 않습니다.',
      stop_voice: '음성 입력 중지',
